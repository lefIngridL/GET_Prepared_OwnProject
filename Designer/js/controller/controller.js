...
function fill(square, [x, y]) {
    ...
    if (myButton.innerText == "╳" && square.style.color == "white" || myButton.innerText == "╳" && square.style.color == '') {
        ...
        activePuzzle.grid[coorID[1]][coorID[0]] = 1;
        console.log(activePuzzle);
    }
...
const emptyOut = square => {
    square.style.backgroundColor = "white";
    square.style.color = "white";
};

const emptyOutx = square => {
    square.style.color = "white";
};
...
function placeNumbersCol(puzzle) {
    ...
    //console.log(LevelObj.level1.puzzles[A].columns);
    //console.log(activePuzzle);
}
