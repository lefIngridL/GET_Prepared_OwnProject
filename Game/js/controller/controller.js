...
function fill(square, [x, y]) {
    ...
    if (myButton.innerText == "╳" && square.style.color == "white" || myButton.innerText == "╳" && square.style.color == '') {
        ...
        activeGame[coorID[1]][coorID[0]] = 2;
        ...
        activeGame[coorID[1]][coorID[0]] = 0;
        console.log(activeGame);
    }
        ...
        activeGame[coorID[1]][coorID[0]] = 1;
        console.log(activeGame);
    ...
    evaluate(square, coorID);
}

function evaluate(square, coorID) {
    let sqrId = square.id;
    let correct;
    ...
    if (activeGame[coorID[1]][coorID[0]] == 1 && activePuzzle.grid[coorID[1]][coorID[0]] == 1) {
        console.log("true");
        correct = true;
        points++;
    }
    else if (activeGame[coorID[1]][coorID[0]] == 1 && activePuzzle.grid[coorID[1]][coorID[0]] == 0) {
        correct = false;
    ...
    else if (activeGame[coorID[1]][coorID[0]] == 2 && activePuzzle.grid[coorID[1]][coorID[0]] == 0) {
        correct = true;
        console.log("true?");
    }
    else if (activeGame[coorID[1]][coorID[0]] == 2 && activePuzzle.grid[coorID[1]][coorID[0]] == 1) {
        correct = false;
        square.style.color = "red";
